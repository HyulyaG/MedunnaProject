...
public class US17_UIAdminStepDefs {
    ...
    public void user_sign_in_as_admin() {
        ...
        Driver.waitAndSendText(us17AdminPage.usernameTextBox,"MyAdminHyu");
        Driver.waitAndSendText(us17AdminPage.passwordTextBox,"MyAdminHyu1990");
