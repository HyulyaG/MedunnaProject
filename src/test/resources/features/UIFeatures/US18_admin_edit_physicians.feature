...
Feature: Admin can search an existing registered person by SSN id
  ...
  Scenario:TC01 search existing registered physician
    Then verify user is on Physician view portal
    Then close the application

  @create_or_edit_physician
    Scenario: TC02 admin can edit physician data
...
#    And provide specialty for the doctor
    ...
    @all_physician_info
    Scenario: TC03 admin can view all Physicians info populated on view portal
