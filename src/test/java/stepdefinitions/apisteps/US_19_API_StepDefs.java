...
public class US_19_API_StepDefs {
    ...
    Response response;
    US19_StaffApi us19_staffApi = new US19_StaffApi();
...
//        (ConfigurationReader.getProperty("admin_password")), (ConfigurationReader.getProperty("staff_endpoint");
