...
public class US17AdminPage {
    ...
    @FindBy(xpath = "//*[@href='/c-test-item/30176/delete?page=3&sort=id,asc']")
    public WebElement deleteItem30176Button;

    @FindBy(xpath = "//*[@href='/c-test-item/30177/delete?page=3&sort=id,asc']")
    public WebElement deleteItem30177Button;

    @FindBy(xpath = "((//*[@href='/c-test-item/33004'])[2]/following::a/following::a)[1]")
