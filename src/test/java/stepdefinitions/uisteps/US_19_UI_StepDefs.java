...
public class US_19_UI_StepDefs {
    ...
    public void user_create_a_new_registrant() {
        ...
        Driver.waitAndSendText(registrationPage.firstNameTextBox,"eymen");
        Driver.waitAndSendText(registrationPage.lastNameTextBox,"arzu");
        Driver.waitAndSendText(registrationPage.userNameTextBox,userName);
        Driver.waitAndSendText(commonPage.email,mail);
        Driver.waitAndSendText(registrationPage.firstPasswordTextBox,"eymen12345");
        Driver.waitAndSendText(registrationPage.secondPasswordTextBox,"eymen12345");
