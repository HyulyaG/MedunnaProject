...
public class US02_ApiValidationSteps {
    ...
    public void user_sends_the_get_request_and_gets_the_response() {
        response = getRequest(generateToken(ConfigurationReader.getProperty("admin_username"), ConfigurationReader.getProperty("admin_password")), ConfigurationReader.getProperty("api_user_by_ssn"));
